const tagOption = ["p", "h1", "h2", "h3", "h4", "h5", "h6", "span"];
...
function createOption() {
  ...
  paragraphsSlider.addEventListener("input", updateParagraphsVlaue);
...
function updateParagraphsVlaue() {
...
function generateLoremIpsum() {
  ...
  const loremIpsumText = gernerateText(
    paragraphs,
    tag,
    includeHtml,
    wordsPerParagraph
...
function gernerateText(paragraphs, tag, includeHtml, wordsPerParagraph) {
